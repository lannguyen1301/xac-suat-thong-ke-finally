...
df.columns = ['Date','Week','Period','Prize','So1','So2','So3','So4','So5','So6','So7']
...
for ngay, group in df.groupby(df['Date'].str.split().str[0], sort=False):
    ...
    day_entry = {"Date": day_str, "Week": clean_val(group.iloc[0]['Week']), "Period": clean_val(group.iloc[0]['Period']), "isRestDay": False, "results": {}, "allNumbers": []}
